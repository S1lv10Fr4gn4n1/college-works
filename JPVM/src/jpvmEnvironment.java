...
public class jpvmEnvironment {
	...
	public static String pvm_daemon_file_name() {
		/*
		 * String osName = System.getProperty("os.name"); String userName =
		 * System.getProperty("user.name"); String fileName = null; if
		 * (osName.equals("Windows 95") || osName.equals("Windows NT") ||
		 * osName.equals("Windows 3.1")) { fileName =
		 * "c:\\temp\\jpvmd-"+userName+".txt"; } else fileName = userName;
		 */
